  ...
  >
    <v-card>
      <v-card-title class="headline">
        Solicitud de turno UTN-FRCU
      </v-card-title>
      <v-expand-transition>
        <div v-if="!loadingRequest && !requestResponse">
          <v-card-text >
            Usted está por solicitar un turno para ingresar a Universidad Tecnológica Nacional <br>
            <br>
            Mediante la confirmación de esta acción se compromete usted a: <br>
            <ul>
              ...
              <li>Portar el DNI como instrumento validador del turno.</li>
