      ...
      <v-card rounded width="100%" justify="center" class="mb-10" style="background-color: rgba(255,255,255,0.9)">
        <v-card-title class="d-block mt-3">
          <p class="text-center display-1" style="word-break: break-word">
            Estás por reservar un turno para asistir a la biblioteca
          </p>
        </v-card-title>
        <v-card-subtitle class="mt-3">
          A continuación deberás completar la siguiente información para tu turno
          <br>
          Luego de completar el formulario, recibiras un código que utilizarás para ingresar a la biblioteca
        </v-card-subtitle>
        <form>
          <v-container>
     

            <h3 class="text-left mx-4">Información del Alumno</h3>
            ...
            <p class="subtitle-1 mx-4 text-left">
              Indicanos cuando querés asistir y a que puesto.
            </p>
            <div class="mb-7">
...
export default {
  ...
  data:() => ({
    participants:[
      {dni:null, transactionId:null, dniError:false}
    ],
    places:[],
  ...
  computed:{
    canAddParticipant(){
      return this.participants.reduce( (acc,x) => { return ((x.dni) ? 0 : 1) + acc} , 0) === 0
    },
    canSubmit(){
